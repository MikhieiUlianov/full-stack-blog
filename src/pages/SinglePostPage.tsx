      ...
      <div className="flex gap-8">
        <div className="lg:w-3/5 flex flex-col gap-8">
          ...
          <p className="text-gray-500 font-medium">
            ...
            praesentium debitis quasi sequi, et eligendi perspiciatis quos iste
            blanditiis facilis delectus id obcaecati. Ipsa doloremque vel
            explicabo earum laudantium. Fugit.
          </p>
        </div>
